...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <section className="relative py-16 bg-gradient-to-r from-purple-300 to-purple-200">
            ...
            >
              ...
              <form onSubmit={onSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  type="submit"
                  className="bg-purple-600 text-white px-8 py-3 rounded-full font-semibold text-lg hover:bg-purple-700 transition-colors duration-300"
                >
                  Submit Form
                </motion.button>
              </form>
              <span className="block mt-4 text-purple-700">{result}</span>
            </motion.div>
      ...
      <section className="py-16 bg-gradient-to-r from-purple-100 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
            ...
            >
              <h3 className="text-xl font-bold text-purple-800 mb-4">Email Us</h3>
            ...
            <motion.div
              ...
              className="bg-white rounded-lg shadow-lg p-6 text-center border border-gray-200"
            >
              <h3 className="text-xl font-bold text-purple-800 mb-4">Company Name</h3>
            ...
            <motion.div
              ...
              className="bg-white rounded-lg shadow-lg p-6 text-center border border-gray-200"
            >
              <h3 className="text-xl font-bold text-purple-800 mb-4">Visit Us</h3>
